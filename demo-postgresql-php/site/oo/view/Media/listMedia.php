...
<a href="?controller=media&action=create" class="btn btn-primary button_mode_top" id="btn_top">+ Ajouter un media</a> <!-- Remplacez 'votre-lien' par l'URL souhaitée -->
<a href="?controller=media&action=create" class="button_mode_bot" id="btn_bot"><p>+</p></a> <!-- Remplacez 'votre-lien' par l'URL souhaitée -->
